...
void QTOgreWindow::initialize()
{
    ...
    */
    ...
    auto ogreRootDirectory = env.value("OGRE_ROOT", "/usr/local/").toStdString();

#ifdef _MSC_VER
    m_ogreRoot = new Ogre::Root(Ogre::String(ogreRootDirectory + "/share/OGRE/plugins" OGRE_BUILD_SUFFIX ".cfg"));
#else
    m_ogreRoot = new Ogre::Root(Ogre::String(ogreRootDirectory + "/share/OGRE/plugins.cfg"));
#endif
    ...
    ogreConfig.load(ogreRootDirectory + "/share/OGRE/resources.cfg");
